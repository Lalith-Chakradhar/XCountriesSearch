...
export default function App() {
  ...
  return (
    <div>
      ...
      <form style={searchBoxContainer} onSubmit={(e) => { e.preventDefault(); searchCountries();}}>
        <input style={searchBox} type="text" value={searchText} onChange={(e) => handleSearch(e)} placeholder="Search for countries..."/>
      </form>
      </div>
